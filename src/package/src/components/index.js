...
const UploadPictures = forwardRef((
  ...
  const getChangedPos = (currentPos, newPos) => {
    ...
    newList.slice(currentPos, 1);
    newList.slice(newPos, 0, newList[currentPos]);
    setPictures(newList)
  };
...
//         open &&
//         (
//           <div ref={ref} className={"modal modal-dialog modal-dialog-centered modal-dialog-scrollable fade " + sizModal + (open ? " show" : "")} tabIndex="-1" id="exampleModal">
//             <div className="modal-dialog">
//               <div className="modal-content">
//                 <div className="modal-header">
//                   <h1 className="modal-title fs-5" id="exampleModalLabel">{title}</h1>
